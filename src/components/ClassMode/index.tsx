...
import type { Assessment, SharedAssignment, AssignmentAttempt } from '../../lib/types'
import {
        ...
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-lg font-bold text-slate-800 flex items-center gap-2">
              <Users className="w-5 h-5 text-blue-500" /> Class Mode
            </h2>
            <p className="text-xs text-slate-400 mt-0.5">Share assessments with your class or join a teacher's assignment.</p>
          </div>
          <button
          ...
          >
            <ChevronRight className="w-3.5 h-3.5" /> Join Assignment
          </button>
        </div>
